...
public interface MemberRepository extends JdbcRepository<Member, String>{
	...
	public static final String COL_FKSKINID = "fkSkinId";
	...
	public static final String COL_CREDENTIALSEXPIREDDATE = "credentialsExpiredDate";
	...
	public static final String FKSKINID = "Member.fkSkinId";
	...
	public static final String CREDENTIALSEXPIREDDATE = "Member.credentialsExpiredDate";
