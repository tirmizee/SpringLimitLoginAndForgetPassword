...
<body class="bg">
  ...
  <div class="login-box-body">
	...
	<form>
		...
		<div class="form-group">
			<button id="btnReset" type="button" class="btn btn-danger btn-block btn-flat" style="width: 100%;font-weight: 800;">Reset Password</button>
	    </div>	
	    <br>
	</form>
  </div>
...
var ForgetPassword = function(){
	...
	var handleButtonResetPassword = function(){
		$('#btnReset').on('click' , function(){
			...
			AjaxManager.PostData(objectData ,"../api/password/reset",
				function(response){
					if (response) {
						swal({ type  : 'success',  
